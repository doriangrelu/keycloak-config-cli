[![CI](https://github.com/adorsys/keycloak-config-cli/actions/workflows/ci.yaml/badge.svg)](https://github.com/adorsys/keycloak-config-cli/actions/workflows/ci.yaml?query=branch%3Amain)
